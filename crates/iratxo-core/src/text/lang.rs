...
const ES_DETECT: &[&str] = &[
    "a","acá","ahí","ahora","al","allá","allí","ante","antes","aquel","aquella","aquellas",
    "aquellos","aquí","así","aún","ayer","bajo","bien","cada","casi","como","cómo","con","contra",
    "cual","cuál","cuales","cuáles","cuando","cuándo","cuanta","cuánta","cuanto","cuánto","cuya",
    "cuyas","cuyo","cuyos","de","del","desde","donde","dónde","durante","el","ella","ellas",
    "ello","ellos","en","entre","era","eran","eres","es","esa","esas","ese","eso","esos","esta",
    "están","estamos","estas","estáis","este","esto","estos","estoy","está","excepto","fue",
    "fueron","gracias","ha","había","hace","hacemos","hacen","hacéis","hago","han","hasta","hay",
    "hacia","hola","hoy","jamás","junto","la","las","le","les","lo","los","luego","mal","más",
    "mañana","me","mediante","mejor","mi","mis","mismo","mucha","muchas","mucho","muchos","muy",
    "nada","nadie","ni","ningún","ninguna","ninguno","no","nos","nosotros","nuestra","nuestras",
    "nuestro","nuestros","nunca","o","os","otra","otras","otro","otros","para","pero","peor",
    "poca","pocas","poco","pocos","por","porqué","porque","pronto","pues","qué","que","quien",
    "quién","salvo","se","según","señor","señora","si","siempre","sin","sino","sobre","son",
    "soy","su","sus","sí","tal","también","tampoco","tan","tanto","tarde","te","temprano",
    "tenéis","tenemos","tengo","tiene","tienen","toda","todas","todavía","todo","todos","tras",
    "tu","tus","tuyo","ud","uds","un","una","unas","uno","unos","usted","ustedes","vez","y","ya",
    "yo",
];
const CA_DETECT: &[&str] = &[
    "a","acabar","ací","açò","ahir","al","alguna","algunes","alguns","algun","allà","allí",
    "altra","altre","altres","amb","ambdós","ans","aquell","aquella","aquelles","aquells","aquest",
    "aquesta","aquestes","aquests","ara","així","avui","bé","bo","cada","cap","cas","cinc","com",
    "contra","còm","d","dalt","damunt","darrer","de","del","dels","dempeus","des","després","deu",
    "dia","dins","dintre","disset","divuit","doncs","dos","dues","durant","e","el","ell","ella",
    "elles","ells","els","em","en","encara","entre","era","eren","ès","es","esa","esos","esta",
    "estan","estar","estat","està","et","ets","fa","fer","feu","fou","gens","gràcies","ha",
    "haver","havien","hem","hi","ho","hola","ja","jo","l","la","les","li","llavors","lo","los",
    "ls","m","mai","massa","més","meu","meus","meva","meves","mi","molt","molta","moltes","molts",
    "n","nho","ni","ningú","no","nogensmenys","nosaltres","nostra","nostre","nostres","o","on",
    "onze","pas","pel","pels","per","però","perquè","poc","pocs","podeu","poder","prou","puc","q",
    "qual","quan","que","què","qui","quin","quina","quines","quins","quinze","s","sa","sant",
    "se","segons","sempre","sense","ser","ses","seu","seus","seva","seves","si","sí","són",
    "sobre","som","sou","soc","sóc","sota","ta","tal","també","tant","tanta","tantes",
    "tants","te","tenia","teniu","tens","teu","teva","teus","teves","ti","ton","tot","tota",
    "totes","tots","tres","tu","u","un","una","unes","uns","us","va","van","vaig","vam","vau",
    "veure","vols","volt","vosaltres","vostra","vostre","vostres","y","ya",
];
const EU_DETECT: &[&str] = &[
