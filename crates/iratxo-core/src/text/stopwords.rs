...
const ES: &[&str] = &[
    ...
    "como", "cómo", "con", "contra", "cual", "cuales", "cuando", "cuanta", "cuanto", "cuya",
    "cuyas", "cuyo", "cuyos", "de", "del", "desde", "donde", "durante", "e", "el", "ella",
    "ellas", "ello", "ellos", "en", "entre", "era", "eran", "eres", "es", "esa", "esas",
    "ese", "eso", "esos", "esta", "está", "están", "estas", "estamos", "este", "esto",
    "estos", "estoy", "excepto", "fue", "fueron", "ha", "había", "hace", "hacia", "han",
    "hasta", "hay", "la", "las", "le", "les", "lo", "los", "luego", "más", "me", "mediante",
    "mejor", "mi", "mis", "mientras", "mismo", "mucho", "muy", "nada", "ni", "ningún", "no",
    "nos", "nosotros", "nuestra", "nuestras", "nuestro", "nuestros", "nunca", "o", "os",
    "otra", "otras", "otro", "otros", "para", "pero", "poco", "por", "porque", "pronto",
    "pues", "que", "qué", "quien", "salvo", "se", "según", "ser", "si", "sí", "siempre",
    "sin", "sino", "sobre", "son", "soy", "su", "sus", "sí", "también", "tampoco", "tan",
    "tanto", "te", "tenemos", "tener", "tengo", "tiene", "tienen", "todo", "todos", "tras",
    "tu", "tus", "un", "una", "unas", "uno", "unos", "y", "ya", "yo",
];
const CA: &[&str] = &[
    "a", "abans", "ací", "açò", "al", "als", "amb", "ambdós", "ans", "aquell", "aquella",
    "aquelles", "aquells", "aquest", "aquesta", "aquestes", "aquests", "ara", "així", "bé",
    "cada", "cap", "com", "contra", "d", "dalt", "darrer", "de", "del", "dels", "des",
    "després", "doncs", "durant", "e", "el", "ell", "ella", "elles", "ells", "els", "em",
    "en", "encara", "entre", "era", "eren", "es", "essent", "està", "estan", "estar", "et",
    "ets", "fa", "fer", "feu", "fins", "fou", "ha", "haver", "havien", "hem", "hi", "ho",
    "i", "ja", "jo", "l", "la", "les", "li", "llavors", "lo", "los", "m", "mai", "massa",
    "més", "meu", "meva", "meves", "meus", "mi", "molt", "molta", "moltes", "molts", "n",
    "ni", "ningú", "no", "nosaltres", "nostra", "nostre", "nostres", "o", "on", "pas", "pel",
    "pels", "per", "però", "perquè", "poc", "pocs", "que", "què", "qui", "quin", "quina",
    "quines", "quins", "s", "sa", "se", "segons", "sempre", "sense", "ser", "ses", "seu",
    "seva", "seves", "seus", "si", "sí", "són", "sobre", "som", "sou", "sota", "ta", "tal",
    "també", "tant", "tanta", "tantes", "tants", "te", "tenia", "teniu", "tens", "teu",
    "teva", "teves", "teus", "ton", "tot", "tota", "totes", "tots", "tu", "u", "un", "una",
    "unes", "uns", "us", "va", "van", "vaig", "vam", "vau", "vosaltres", "vostra", "vostre",
    "vostres", "y", "ya",
];
const EU: &[&str] = &[
